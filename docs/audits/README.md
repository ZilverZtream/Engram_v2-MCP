...
| 4 | Exact entity/consumer discovery | get_concept_footprint, find_symbol_references | [`04-concept-and-consumer-discovery.md`](04-concept-and-consumer-discovery.md) | **slices 1-5 IMPLEMENTED + deployed 2026-08-29** (bc15026, 09aac51, 1499b3f, 59f2005, A11 ceiling 500 in release11; G1 25 % → 94 %; `grep_project` case variants; text sections listable in full). Open: A4 aliases, A6 classification, A8/A9 symbol-reference caps |
...
| 8 | Security / settings / durable laws | map_guards_and_settings, repo rules, immune_check | [`08-guards-and-settings.md`](08-guards-and-settings.md) | **slices 1-2 IMPLEMENTED + deployed 2026-08-29** (95ac7d8 three-state verdicts, helper credit, lists never cut, store-scoped scan, coverage; release11 ROLE-ONLY client-input rule + honest immune_check). Live: ioGetCountByCategory printed UNGUARDED, 0.38 s. Open: conditional own-check credit, B policy model |
