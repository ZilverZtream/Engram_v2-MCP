...
| 1 | Story-to-change scope | get_change_set (+ detect_incomplete_changes, find_similar_changes) | [`03-story-to-change-scope.md`](03-story-to-change-scope.md) | **slices 1-2 IMPLEMENTED + deployed**; slice 3 (D10: permission-gates cut stated in markdown + JSON) GREEN locally 2026-08-29, in sweep21. Open: A3 precision (deferred), cohort precompute |
...
| 4 | Exact entity/consumer discovery | get_concept_footprint, find_symbol_references | [`04-concept-and-consumer-discovery.md`](04-concept-and-consumer-discovery.md) | **slices 1-9 IMPLEMENTED + deployed 2026-08-29 04:31** (… 2b85769 symbol-reference caps; 5afa6e2 every incoming count names its rule; a6825ce consumer roles; 05ec8fb Swedish stems — all live). Slice 10 (export words narrowed, live finding) in sweep21. Open: A4 alias layer proper |
