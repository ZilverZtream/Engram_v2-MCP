...
| 1 | Story-to-change scope | get_change_set (+ detect_incomplete_changes, find_similar_changes) | [`03-story-to-change-scope.md`](03-story-to-change-scope.md) | **IMPLEMENTED slices 1/2/4 + deployed 2026-08-28** (e7356a9, 665792d, 0047b06, bc15026; 5-PR recall gate ⇒ concept expansion OPT-IN; live 27-32 s → 9.7 s). Open: precision A/B (needs Workflow opt-in), A3 cohorts |
...
| 3 | Pre-commit defect prevention | pre_commit_review, pre_push_audit | [`05-pre-commit-gates.md`](05-pre-commit-gates.md) | **slices 1+2 IMPLEMENTED + deployed 2026-08-28** (777c951 gate outcomes; 9da8522 DEGRADED status when a provider fails inside a gate, 8 gates instrumented). Open: A4 caps, A5 unwired, A6 pre_push_audit |
| 4 | Exact entity/consumer discovery | get_concept_footprint, find_symbol_references | [`04-concept-and-consumer-discovery.md`](04-concept-and-consumer-discovery.md) | **slices 1-4 IMPLEMENTED + deployed + live 2026-08-28** (bc15026, 09aac51, 1499b3f, 59f2005 query-time case variants over the case-preserving trigram index; G1 25 % → **226/240 = 94 %**; `grep_project personalliggare` now 38/38). Slice 5 (A11 ceiling) in flight; open: A4 aliases, A6, A8, A9 |
| 5 | House pattern + UI conformance | find_implementation_pattern, analyze_file_coding_style, get_ui_conformance (M0 A/B) | [`07-house-pattern-and-ui-conformance.md`](07-house-pattern-and-ui-conformance.md) | **slices 1+2 green locally 2026-08-28** (kind-filtered, graph-derived shapes + common shapes + PatternCoverage; computed confidence + Basis line, VB analyser always, failures reported) — sweep13/deploy pending. M0 A/B blocked on user opt-in |
| 6 | NL project understanding | ask_codebase | — | healthy (M1 shipped 2026-08-21); larger golden suite later |
| 7 | Causal UI/data tracing | trace_ui_event, trace_data_flow, find_connection_path | [`06-causal-trace-engine.md`](06-causal-trace-engine.md) | **slice 1 deployed + live, slice 2 committed 2026-08-28** (b0369f6; e400653 bounded follow with stated stops + qualified-member resolution found LIVE). Live: no false step, 10 calls as steps, "within 8 hops". A6 find_connection_path in flight |
| 8 | Security / settings / durable laws | map_guards_and_settings, repo rules, immune_check | [`08-guards-and-settings.md`](08-guards-and-settings.md) | **slice 1 green locally 2026-08-28** (three-state verdicts, helper credit, lists never cut, store-scoped scan, coverage) — sweep13/deploy pending; slice 2 (ROLE-ONLY client-input rule, immune_check) RED written |
