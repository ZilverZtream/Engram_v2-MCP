...
| 4 | Exact entity/consumer discovery | get_concept_footprint, find_symbol_references | [`04-concept-and-consumer-discovery.md`](04-concept-and-consumer-discovery.md) | **slices 1-10 IMPLEMENTED + deployed 2026-08-29 05:06** (… a6825ce consumer roles; 05ec8fb Swedish stems; edfe856 "report" is not an export word). Slice 11 (`file:` consumers classified by their own path — live finding) in sweep22. A4 alias layer deferred on evidence |
