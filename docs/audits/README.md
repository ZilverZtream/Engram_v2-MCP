...
| 3 | Pre-commit defect prevention | pre_commit_review, pre_push_audit | [`05-pre-commit-gates.md`](05-pre-commit-gates.md) | **slices 1-4 IMPLEMENTED + deployed 2026-08-29** (777c951 gate outcomes; 9da8522 DEGRADED; 6f149c8 every in-gate cap on the outcome — live "## Caps hit"; A5 unwired failed-lookup ⇒ skip in release13). Open: A6 pre_push_audit tally / OciusX rule ingestion |
| 4 | Exact entity/consumer discovery | get_concept_footprint, find_symbol_references | [`04-concept-and-consumer-discovery.md`](04-concept-and-consumer-discovery.md) | **slices 1-6 IMPLEMENTED + deployed 2026-08-29** (bc15026, 09aac51, 1499b3f, 59f2005, 8ff187f ceiling 500 ⇒ G1 240/240, 2b85769 find_symbol_references caps: live "50+ (fetch cap 50)" + Coverage). Open: A4 aliases, A6 classification, A9 shared incoming count |
| 5 | House pattern + UI conformance | find_implementation_pattern, analyze_file_coding_style, get_ui_conformance (M0 A/B) | [`07-house-pattern-and-ui-conformance.md`](07-house-pattern-and-ui-conformance.md) | **slices 1-3 IMPLEMENTED + deployed 2026-08-29** (95ac7d8 kind-filtered graph-derived exemplars + coverage; 451d5d0 engine confidence + Basis, VB analyser always; release11 control-side page words + versioned style cache). Live: 4/5 kind-correct at ~1 s. M0 A/B blocked on user opt-in |
...
| 8 | Security / settings / durable laws | map_guards_and_settings, repo rules, immune_check | [`08-guards-and-settings.md`](08-guards-and-settings.md) | **slices 1-3 IMPLEMENTED + deployed 2026-08-29** (95ac7d8 three-state verdicts + helper credit + store scope + coverage; 8ff187f ROLE-ONLY rule + honest immune_check; 195d3c8 POST-body reads). Live: the six-endpoint truth table is correct on verdict/level/reads (21 ROLE-ONLY, 0 object-level). Slice 4 (branch-only own check ⇒ helper credited) in release13. Open: B policy model |
