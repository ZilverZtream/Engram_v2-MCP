...
| P0-3 change-set precision/ranking | fixed@06219bd (r36) + P0-3b name-leads-tier (cycle 20b, r37 pending) | LIVE r36 reference story: 174 candidates, PRIMARY set 40 (cap 40), 43 omissions; broad terms refused and named in coverage ('main' 860 files, 'reporting' 358, 'category' 286, 'kategori' 117); ranks api-redovisning.vb 1, redovisningskategorier.vb 3, iFalt.dbml 16, rk_redovisningskategorier.sql 27; page + code-behind tier 0 (`name`+`vector`) at 42/43 → 4/6 within top 30. Tests: change_set_rank_tests (rank-based acceptance on the reference-story shape, broad-term noise never primary, name coverage, markdown order). P0-3b makes story-word name coverage lead its tier (unit test: the pair takes ranks 1–2) — live re-run in r37 must show 6/6 |
