...
- Move `planned` capabilities toward `partial` by implementing baseline behavior.
- Harden `partial` areas with stronger coverage and quality gates.
- Graduate `experimental` capabilities after tuning and reliability work.
